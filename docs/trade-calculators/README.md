...
| [`10-roofer.md`](10-roofer.md) | Input/Output matrix — Roofer |
...
| [`trade-packs/roofer.pack.json`](trade-packs/roofer.pack.json) | Sixth pack — exposed a circular dependency present since v1 |
